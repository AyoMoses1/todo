...
```sh
  cd your-folder
  git clone https://github.com/AyoMoses1/todo.git
```
...
I would like to thank The entire App Academy team for instilling in me the drive to complete this project in the shortest possible time. Thanks!!!
